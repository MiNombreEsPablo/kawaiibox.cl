      ...
      k.provide("createLightboxContainer", function (e, t) {
        if (
          ...
          (i.id = k.defaults.lightboxId),
            ...
            (i.style.bottom = "0"),
            (i.style.right = "0"),
            (i.style.title = "Instagram Gallery"),
            (i.style.padding = 0),
            (i.style.margin = 0),
    ...
    P.provide("callCallback", function (e) {
      ...
      k.provide("forceAttribution", function () {
        ...
        (e.id = "powered_by_pixlee" + b()),
          ...
          e.setAttribute(
            "style",
            'height: 8px!important;width:96px!important;display:block!important;background-image:url("")!important;background-size:96px 8px!important;background-position:center!important;background-repeat:no-repeat!important;background-color:transparent!important;padding:4px 0!important;margin:0 auto!important;line-height:0!important;font-size:0!important;color:transparent!important;'
          );
        var t = function (e) {
          var i = e.target;
          i &&
